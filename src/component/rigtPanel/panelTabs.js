...
export default function RightTabPanel({ nodefromshowRoutes, setJobIdSidetoBottom }) {
  ...
  const getNodeId = Nodesdata.filter((item) => item.id === nodefromshowRoutes).map((item) => (item.nodeId))
