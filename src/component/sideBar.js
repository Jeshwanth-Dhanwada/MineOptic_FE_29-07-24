                  ...
                  <React.Fragment>
                    ...
                    <Menu {...bindMenu(popupState)}>
                      ...
                      <Link
                        ...
                        style={{ textDecoration: "none", color: "white" }}
                      >
                        <span className="" style={active === 'Replay Analysis' ? { color: "#034661" } : { color: "#8C8C8C" }}>Replay Analysis</span>
                      </Link>
                      </MenuItem>
                      <MenuItem 
                      // style={active === 'Activity Analysis' ? { backgroundColor: "#E6ECEF" } : { backgroundColor: "#ffffff" }}
