...
function OperationsOutput({ JobfromOperations, RecentActvityData, outputDatafromActivity, inputdatafromActivity }) {
  console.log(JobfromOperations);
            ...
            <table className="table table-bordered table-striped">
              <thead className="sticky-top">
                {/* <tr>
                  ...
                  <th style={{fontSize:'11px'}}>consumedActivity Id</th>
                  <th style={{fontSize:'11px'}}>Node Id</th>
                  <th style={{fontSize:'11px'}}>Description</th>
                  <th style={{fontSize:'11px'}}>Produced At</th>
                  <th style={{fontSize:'11px'}}>producedQty1</th>
                  <th style={{fontSize:'11px'}}>Consumed quantity1</th>
                  <th style={{fontSize:'11px'}}>Balance quantity1</th>
                  <th style={{fontSize:'11px'}}>producedQty2</th>
                  <th style={{fontSize:'11px'}}>Consumed quantity2</th>
                  <th style={{fontSize:'11px'}}>Balance quantity2</th>
                  <th style={{fontSize:'11px'}}>Last Consumed At</th>
                  <th style={{fontSize:'11px'}}>Fineshed Good Id</th>
                  <th style={{fontSize:'11px'}}>Produced Job Id</th>
                  <th style={{fontSize:'11px'}}>Last consumed JobId</th>
                  <th style={{fontSize:'11px'}}>totalProducedQty</th>
                  <th style={{fontSize:'11px'}}>outstandingQty</th>
