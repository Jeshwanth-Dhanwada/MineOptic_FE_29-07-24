      ...
      <div className="row">
        ...
        <Box sx={{ position: "relative" }}>
          <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
            ...
            >
              <Tab style={{fontSize:'10.5px',fontWeight:'bold',color:'#FFFFFF', backgroundColor: value === 0 ? "#fc9445" : "#09587c"}} label="Jobs Planned" {...a11yProps(0)} />
              <Tab style={{fontSize:'10.5px',fontWeight:'bold',color:'#FFFFFF', backgroundColor: value === 1 ? "#fc9445" : "#09587c"}} label="Jobs Completed" {...a11yProps(1)} />
              <Tab style={{fontSize:'10.5px',fontWeight:'bold',color:'#FFFFFF', backgroundColor: value === 2 ? "#fc9445" : "#09587c"}} label="Materials" {...a11yProps(2)} />
            </Tabs>
          </Box>
