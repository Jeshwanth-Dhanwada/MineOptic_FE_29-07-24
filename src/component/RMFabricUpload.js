                ...
                <div className="d-flex mt-2 container-fluid justify-content-center">
                    <div className="row">
                        <div className="col-12">
                            ...
                            <button className="btn btn-success" onClick={handleSubmitRolls}><FaCheck /></button> &nbsp;
                            <button className="btn btn-danger" onClick={handleCancelClick}><FaXmark /></button>
                        </div>
                    </div>
                </div>
            )}
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="d-flex justify-content-end">
                                <button className="btn btn-success" onClick={handleCheckClick}><FaCheck /></button> &nbsp;
                                <button className="btn btn-danger" onClick={handleCancelClick}><FaXmark /></button>
                            </div>
                            <table className="m-2 table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>Date</th>
                                        <th>Roll ID</th>
