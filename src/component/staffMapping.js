...
function StaffMapping() {
  ...
  return (
    <div style={{ display: "flex" }} >
      ...
      >
        <div className="row p-1 d-flex flex-row justify-content-center">
              ...
              <table className="table table-striped table-bordered">
                <thead class="sticky-top">
                  <tr>
                    ...
                    <th style={{fontSize: "11px"}}>Equipment ID</th>
                    <th style={{fontSize: "11px"}}>Equipment Name</th>
                    <th style={{fontSize: "11px"}}>Employee ID</th>
                    <th style={{fontSize: "11px"}}>Employee Name</th>
                    <th style={{fontSize: "11px"}}>Shift ID</th>
                    <th style={{fontSize: "11px"}}>Assigned Date</th>
                  ...
                  {NodeAllocation.map((item, index) => (
                    <tr>
                      ...
                      <td>
                        ...
                        {editedIndex === index ? (
                          <>
                            <button style={{ border: 'none', backgroundColor: 'transparent' }} onClick={handleSave}><FaCheck /></button>
                          </>
                        ) : (
