    ...
    return (
        <>
            ...
            <div style={{ display: "flex" }}>
                ...
                >
                    <div className="row ">
                        <div className="col-12" style={{ height: "100vh", overflow: "auto" }}>
                            <table className={"table table-bordered table-striped"}>
                                <thead className="sticky-top">
                                    <tr>
                                        <th style={{whiteSpace: "nowrap",fontSize: "11px"}}>
                                            {itemCodeSearchVisible ? (
                                                <div className="search-input-container" style={{ position: 'relative', top: '2px', left: '0px', backgroundColor: 'white' }}>
                                                    <TextField
                                                        type="text"
                                                        variant="outlined"
                                        ...
                                        <th style={{ width: '151px',whiteSpace: "nowrap",fontSize: "11px" }}>{nodeDescSearchVisible ? (
                                            <div className="search-input-container" style={{ position: 'relative', top: '0px', backgroundColor: 'white' }}>
                                                <TextField
                                                    type="text"
                                                    variant="outlined"
