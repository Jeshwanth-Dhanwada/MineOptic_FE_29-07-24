...
function MaterialCategory() {
  ...
  useEffect(() => {
    const editPCD = data.filter(item => item.id == MaterailCatId)
                        .map(item => item.productTypeDescription)
    setEditproductDesc(editPCD)
  },[MaterailCatId, data])
  ...
  function updateFields(event){
    ...
    const payload = {
      branchId : "1001",
      userId: "1111",
      productTypeDescription:EditproductDesc.toString()
    }
              ...
              <Table sx={{ minWidth: 465 }} aria-label="simple table">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell style={{fontSize:'11px'}}>Product Type Description</TableCell>
                ...
                <TableBody>
                  ...
                  filteredResults.map((row) => (
                    ...
                    >
                      ...
                      <TableCell style={{fontSize:'11px'}}>{row.productTypeDescription}</TableCell>
