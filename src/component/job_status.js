        ...
        >
          <table className={"table table-bordered table-striped"}>
            ...
            <thead class="sticky-top">
              <tr>
                <th style={{ width: '11.5%',fontSize: "11px" }}>Job ID
                  {isSearchVisible ? (
                  ...
                  {/* <Dropdown drop="down-centered">Job ID
                  <Dropdown.Toggle variant="white" size="sm" style={{border:'none'}}  id="dropdown-basic">
                    
                  </Dropdown.Toggle>

                  <Dropdown.Menu style={{ maxHeight: '100px',width:'100px', overflowY: 'auto' }}>
                    {jobs().map(item => 
                    <Dropdown.Item onClick={() => handleMenuClickForJobId(item)}>{item}</Dropdown.Item>
                    )}
                  </Dropdown.Menu>
                </Dropdown> */}
                </th>
                <th style={{fontSize: "11px"}}>Item Description</th>
                <th style={{fontSize: "11px"}}>IT CODE</th>
                <th style={{fontSize: "11px"}}>Job Qty (m)</th>
                <th style={{fontSize: "11px"}}>Perimeter</th>
                <th style={{fontSize: "11px"}}>Target Qty (m)</th>
                <th style={{fontSize: "11px"}}>Delivery Date</th>
