            ...
            <div className="d-flex justify-content-around">
                <div className="d-flex m-2 justify-content-center ">
                    ...
                    <input
                        ...
                        style={{ border: 'none',fontSize:'13px', width: '120px', height: '25px', backgroundColor: 'whitesmoke', paddingRight: "10px" }}
                    />
                ...
                <div className="d-flex m-2 justify-content-center">
                    <h6 style={{ paddingTop: "5px", marginRight: "5px" }}>Machine Node </h6>
                    <Dropdown>
            ...
            <div style={{ display: "flex" }}>
                ...
                >
                    <div>
                        ...
                        >
                            <table className={"table table-bordered table-striped"} style={{ width: "100%", height: "100%", overflow: "auto" }}>
